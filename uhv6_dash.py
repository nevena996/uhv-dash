...
# LOAD DATA
# =============================
data_path = "../data/new_datasets/Unplaned_Hospital_Visits/Unplanned_Hospital_Visits-Hospital.csv"
df_raw = load_data(data_path)
state_data_path = "../data/new_datasets/Unplaned_Hospital_Visits/Unplanned_Hospital_Visits-State.csv"
